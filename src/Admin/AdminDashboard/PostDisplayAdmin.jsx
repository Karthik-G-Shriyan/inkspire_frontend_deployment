...
import { FiCalendar, FiTag, FiChevronLeft, FiChevronRight, FiArrowLeft } from "react-icons/fi";
import { MdVerified } from "react-icons/md";
import { deletePost } from "../AdminService";
import { toast } from "react-toastify";


const PostDisplayAdmin = () => {
    const { postsByPage, storePosts, totalPages, loading: contextLoading, token } = useContext(StoreContext);
            ...
            <div className="flex justify-center items-center gap-2 mt-8">
                ...
                <div className="hidden sm:flex items-center gap-2">
                    ...
                    {visiblePages.map((page) => (
                        <button
                            key={page}
                            className={`px-4 py-2 rounded-lg font-semibold transition-all duration-200 ${page === currentPage
                                    ...
                                    <div className="p-6 md:p-8">
                                        ...
                                        <div className="flex items-center gap-3 mb-4">
                                            ...
                                            <button
                                                onClick={(e) => {
                                                    e.stopPropagation();
                                                    handleDeletePost(post.publicId);
                                                }}
                                            ...
                                            >
                                                ...
                                                {deletingPostId === post.publicId ? "Deleting..." : "Delete"}
                                            </button>
                                        </div>
...
export default PostDisplayAdmin;